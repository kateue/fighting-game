...
const player = new Fighter({
	...
	sprites: {
		...
		run: {
			imageSrc: './img/goodWiz/Run.png',
			framesMax: 8
		},
		jump: {
			imageSrc: './img/goodWiz/Jump.png',
			framesMax: 2
		},
		fall: {
			imageSrc: './img/goodWiz/Fall.png',
			framesMax: 2
		},

		attack1: {
			imageSrc: './img/goodWiz/Attack1.png',
			framesMax: 8
		},
		takeHit: {
			imageSrc: './img/goodWiz/Hit.png',
			framesMax: 4
		},
		death: {
			imageSrc: './img/goodWiz/Death.png',
			framesMax: 7
		}
...
function animate(){
	...
	player.velocity.x = 0 //stops player if keyup
	enemy.velocity.x = 0
